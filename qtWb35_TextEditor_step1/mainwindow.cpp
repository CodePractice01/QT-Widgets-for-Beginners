...
void MainWindow::newFile()
{
    ...
    m_filename.clear();
    m_saved =false;
    ui->statusbar->showMessage("Newq file");
...
void MainWindow::openFile()
{
    ...
    QString temp = QFileDialog::getOpenFileName(this, "Open File",QString(), "Text File(*txt);;All Files(*,*)");
...
{
    QString temp = QFileDialog::getOpenFileName(this, "Save File",QString(), "Text File(*txt);;All Files(*,*)");
