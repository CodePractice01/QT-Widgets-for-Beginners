    ...
    , ui(new Ui::Dialog)
{
    ...
    btnReject->setIcon(QIcon(":/dialog/images/cancel.jpg"));
...
void Dialog::save()
{
    ...
    //display the text saved by the user
...
void Dialog::closeEvent(QCloseEvent *event)
{
    ...
    if(!m_saved)
    {
        QMessageBox::StandardButton btn = QMessageBox::question(this, "Save File?", "Your file gas changes would you like to save?");
