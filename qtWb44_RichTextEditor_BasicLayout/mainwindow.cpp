...
void MainWindow::on_actionExist_triggered()
{
    close();
}
...
void MainWindow::on_actionFind_triggered()
{
    ...
    if(!value) QMessageBox::information(this,"Not Fount","Was no able to find:" + dlg->text());
...
void MainWindow::on_actionBold_triggered()
{
    ...
    // if font is already bold, set value to false , : else setBold to true
...
{
    //we get the color dialog, and then set what color we want
...
{
    ui->textEdit->insertHtml("<font size = '40' color='red'> <b>T</b><i>est</i> </font><br>");
    ui->textEdit->insertHtml("<ul><li>Coffe</li> <li>Tea</li> <li>Water</li></ul>");
}
